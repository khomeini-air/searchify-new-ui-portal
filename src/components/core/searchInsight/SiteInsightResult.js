    ...
    return (
        <>
            <div className={styles.SearchInsightResult__wrapper}>
                <h2 className={styles.pageOverview__title}>SITE SEO EDITTED</h2>
                                ...
                                <li className={styles.__project__list_items}>
                                        <div className={styles.__project_detailsbox}>
                                            ...
                                            <div style={{"width": "60%"}} className={styles.__project_details__Itembox}>
                                                <h5 className={styles.__details_list__title}>PAGE SEO</h5>
                                            </div>
                                            
                                        </div>
                                    </li>
                                {getWebsite() && getWebsite().webpages && getWebsite().webpages.map((link) => (
                                    <li className={styles.__project__list_items}>
                                        <div className={styles.__project_detailsbox}>
                                            <div style={{"width": "40%"}} className={styles.__project_details__Itembox}>
                                            ...
                                            <h5 className={styles.__details_list__title}>Title</h5>
                                                <p className={styles.normal_text}>{pickupFieldFromSuggestion(link.currentSuggestion, "title").value}</p>
                                            </div>
                                        </div>
...
export default SiteInsightResult